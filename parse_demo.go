...
type GameRound struct {
	...
	Reason               int                `json:"roundEndReason"`
...
type DamageAction struct {
	...
	WeaponClass      int      `json:"weaponClass"`
	...
	for _, w := range p.Weapons() {
		if w != nil {
			if (w.String() != "Knife") && (w.String() != "C4") {
				...
				currentWeapon.WeaponClass = int(w.Class())
	...
	*/
	...
	p.RegisterEventHandler(func(e events.WeaponFire) {
		...
		if (e.Weapon != nil) && (e.Weapon.String() != "Knife") && (e.Weapon.String() != "C4") && (e.Shooter != nil) {
			...
			currentWeaponFire.WeaponClass = int(e.Weapon.Class())
	...
	p.RegisterEventHandler(func(e events.Kill) {
		...
		if e.Weapon != nil {
			...
			currentKill.WeaponClass = int(e.Weapon.Class())
		}
	...
	p.RegisterEventHandler(func(e events.PlayerHurt) {
		...
		if e.Weapon != nil {
			...
			currentDamage.WeaponClass = int(e.Weapon.Class())
		}
		currentDamage.HitGroup = string(e.HitGroup)
